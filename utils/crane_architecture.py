...
class CRANEBlock(nn.Module):
    ...
    def forward(self, lang_feats, lang_attention_mask,
        ...
        #self-attention
        lang_self_att_output, audio_self_att_output = self.self_att(lang_feats, lang_attention_mask,
                                                      audio_feats, audio_attention_mask)
        #residual connection
        residual_lang_output =  lang_self_att_output +  lang_feats
        residual_audio_output =  audio_self_att_output + audio_feats
