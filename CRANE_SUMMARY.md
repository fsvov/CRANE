...
$`\mathrm{Avg\ conf}_{text} = 0.9767`$ — 模型极度信任文本<br>
$`\mathrm{Avg\ conf}_{audio} = 0.3696`$ — 音频被选择性使用<br>
...
$`n_{cal}=20`$ : Coverage ≈ 87.3%<br>
$`n_{cal}=40`$ : Coverage ≈ 91.3% ← 40 个样本附近即稳定<br>
...
$`\alpha=0.10`$: Coverage = 88.3%, Avg set size = 2.93<br>
